...
def main(savings_account):
    ...
    interest_rate = float(input("Enter the savings account interest rate (as a percentage): "))
    ...
    cd_interest_rate = float(input("Enter the CD account interest rate (as a percentage): "))
